...
import (
	"github.com/rancher/helm-project-operator/pkg/helm-project-operator/apis/helm.cattle.io/v1alpha1"
	"github.com/rancher/helm-project-operator/pkg/helm-project-operator/crd"
	"os"
...
func main() {
	...
	controllergen.Run(args.Options{
		OutputPackage: "github.com/rancher/helm-project-operator/pkg/helm-project-operator/generated",
